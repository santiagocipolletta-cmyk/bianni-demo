...
const NAV_LINKS = [
  ...
  { href: '/admin/representantes', label: 'Alta de Ópticas',  icon: UserPlus        },
  ...
  { href: '/admin/listas-precios', label: 'Listas de Precios',icon: Layers          },
  { href: '/admin/stock',          label: 'Stock',            icon: Package         },
  { href: '/admin/preventas',      label: 'Preventas',        icon: Sparkles        },
